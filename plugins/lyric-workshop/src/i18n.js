...
const DICT = {
  zh: {
    ...
    'save.saving': '保存中…',
    'save.savedTo': '已保存到 {path}',
    'save.picked': '已保存到所选位置',
    'save.downloaded': '已通过浏览器下载（下载文件夹）',
    'save.downloadedWarn': '本地保存失败，已改为浏览器下载：{msg}',
    'save.failed': '保存失败：{msg}',
    'save.fallbackLog': '本地写入失败，已回退浏览器下载：{msg}',
    'err.generic': '出错了：{msg}',
    'misc.noLyric': '暂无歌词',
    'view.single': '单曲搜索',
    'view.batch': '文件夹批量',
    'view.library': '曲库下载',
    'platform.all': '全部平台',
    'platform.allTip': '同时搜索网易云 / QQ音乐 / 酷狗，结果交错合并',
    'theme.toLight': '切换到浅色主题',
    'theme.toDark': '切换到深色主题',
    'head.quickSave': '一键保存',
    'head.chooseFmt': '选择一键下载的默认格式',
    'quick.title': '一键下载歌词（按默认格式）',
    'quick.noLyric': '未找到可用歌词',
    'quick.saved': '✓ 已保存到 {path}',
    'quick.downloaded': '✓ 已通过浏览器下载 {file}',
    'quick.fail': '一键下载失败：{msg}',
    'quick.targetSet': '一键下载格式已设为 {fmt}',
    'kbd.hint': '↑↓ 选择 · Enter 打开 · Ctrl+↵ 一键下载 · Ctrl+K 搜索',
    'history.clear': '清空',
    'search.partial': '{n} 个平台本次搜索失败，结果不全',
    'filter.all': '全部',
    'filter.placeholder': '筛选文件名…',
    'filter.none': '没有符合筛选条件的曲目',
    'batch.dlOne': '下载歌词（覆盖）',
    'batch.runCount': '下载缺失歌词（{n}）',
    'library.runCount': '下载缺失歌词（{n}）',
    'batch.pick': '选择文件夹',
    'batch.files': '{n} 个音频',
    'batch.platform': '搜索平台',
    'batch.format': '导出格式',
    ...
    'library.brand': 'JuicyPlayer 曲库',
    'library.loading': '正在读取曲库文件夹…',
    'library.none': '曲库里还没有音乐文件夹',
    'library.fail': '无法读取 JuicyPlayer 曲库（请确认播放器在运行）',
    'library.loadTracks': '加载曲目',
    'library.loadedFolders': '已获取曲库文件夹 {n} 个',
    'library.tracks': '曲库 {name}：{n} 首',
    'library.count': '{n} 首',
    'library.run': '下载缺失歌词',
    'library.dlOne': '下载歌词',
    'library.empty': '选择曲库文件夹开始',
    'library.emptySub': '列出曲库曲目，单曲或批量下载歌词，直接写入音频所在文件夹',
    'library.targetLabel': '单曲保存到',
    'library.targetPlaceholder': '例如 D:\\Music（未设置时自动用第一个曲库文件夹）',
    'library.targetSet': '设置',
    'library.targetSetDone': '已设置',
  },
  en: {
    ...
    'save.saving': 'Saving…',
    'save.savedTo': 'Saved to {path}',
    'save.picked': 'Saved to chosen location',
    'save.downloaded': 'Downloaded via browser (Downloads folder)',
    'save.downloadedWarn': 'Local save failed; fell back to browser download: {msg}',
    'save.failed': 'Save failed: {msg}',
    'save.fallbackLog': 'local write failed; fell back to browser download: {msg}',
    ...
    'platform.allTip': 'Search NetEase / QQ Music / KuGou at once, results interleaved',
    'theme.toLight': 'Switch to light theme',
    'theme.toDark': 'Switch to dark theme',
    'head.quickSave': 'Quick save',
    'head.chooseFmt': 'Choose the default format for quick download',
    'quick.title': 'Quick-download lyrics (default format)',
    'quick.noLyric': 'no lyric available',
    'quick.saved': '✓ Saved to {path}',
    'quick.downloaded': '✓ Downloaded via browser: {file}',
    'quick.fail': 'Quick download failed: {msg}',
    'quick.targetSet': 'Quick-download format set to {fmt}',
    'kbd.hint': '↑↓ select · Enter open · Ctrl+↵ quick download · Ctrl+K search',
    'history.clear': 'Clear',
    'search.partial': '{n} platform(s) failed this search — results incomplete',
    'filter.all': 'All',
    'filter.placeholder': 'Filter by name…',
    'filter.none': 'No tracks match the filter',
    'batch.dlOne': 'Download lyrics (overwrite)',
    'batch.runCount': 'Download missing ({n})',
    'library.runCount': 'Download missing ({n})',
    ...
    'library.brand': 'JuicyPlayer Library',
    'library.loading': 'Loading library folders…',
    'library.none': 'No music folders configured in the library yet',
    'library.fail': 'Cannot read the JuicyPlayer library (is the player running?)',
    'library.loadTracks': 'Load tracks',
    'library.loadedFolders': 'Loaded {n} library folder(s)',
    'library.tracks': 'Library {name}: {n} track(s)',
    'library.count': '{n} track(s)',
    'library.run': 'Download missing lyrics',
    'library.dlOne': 'Download lyrics',
    'library.empty': 'Pick a library folder to start',
    'library.emptySub': 'List library tracks and download lyrics right next to the audio files',
    'library.targetLabel': 'Single-save folder',
    'library.targetPlaceholder': 'e.g. D:\\Music (defaults to the first library folder)',
    'library.targetSet': 'Set',
    'library.targetSetDone': 'Set',
  },
};

...
const f = (state, key) => {
  ...
  const t2 = (bitnumIntl(state, 15, 0) | (state & 61440) << 15 | bitnumIntl(state, 20, 5) | bitnumIntl(state, 19, 6) | (state & 3840) << 13 | bitnumIntl(state, 24, 11) | bitnumIntl(state, 23, 12) | (state & 240) << 11 | bitnumIntl(state, 28, 17) | bitnumIntl(state, 27, 18) | (state & 15) << 9 | bitnumIntl(state, 0, 23)) >>> 0;
  const lrgstate = [
    t1 >>> 24 & 255 ^ key[0],
    t1 >>> 16 & 255 ^ key[1],
    t1 >>> 8 & 255 ^ key[2],
